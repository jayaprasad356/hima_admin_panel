...
class Users extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = [
        ...
        'language', 'voice', 'describe_yourself', 'interests', 'status','balance','audio_status','video_status','bank','branch','ifsc','account_num','holder_name','total_income','attended_calls','missed_calls','avg_call_percentage','blocked','priority','pancard_name','pancard_number'
    ];
