        ...
        <ul class="dash-navbar">
            ...
            <!--    </li> -->
                ...
                <a href="<?php echo e(route('withdrawalsreports.index')); ?>" class="dash-link">
                 ...
                 <li class="dash-item">
                <a href="<?php echo e(route('usersreports.index')); ?>" class="dash-link">
                    <span class="dash-micon">
                        <i class="ti ti-users"></i> <!-- Icon for withdrawals -->
                    </span>
                    <span class="dash-mtext"><?php echo e(__('Users Reports')); ?></span>
                </a>
                </li>
                  <li class="dash-item">
                <a href="<?php echo e(route('femalereports.index')); ?>" class="dash-link">
                    <span class="dash-micon">
                        <i class="ti ti-users"></i> <!-- Icon for withdrawals -->
                    </span>
                    <span class="dash-mtext"><?php echo e(__('Female Reports')); ?></span>
                </a>
                </li>
                 <li class="dash-item">
                ...
                <a href="<?php echo e(route('gifts.index')); ?>" class="dash-link">
                 ...
                 <li class="dash-item">
                    <a href="<?php echo e(route('fcm_token.index')); ?>" class="dash-link">
                        <span class="dash-micon">
                        <i class="ti ti-bell"></i> <!-- Updated icon for notifications -->
                        </span>
                        <span class="dash-mtext"><?php echo e(__('Fcm Tokens')); ?></span>
                    </a>
                </li>
...
<?php /**PATH C:\xampp\htdocs\hima_admin_panel-3\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>