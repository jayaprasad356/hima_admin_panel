                ...
                <form action="<?php echo e(route('users.index')); ?>" method="GET" class="mb-3">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                            <label for="priority"><?php echo e(__('Filter by Priority')); ?></label>
                            <select name="priority" id="priority" class="form-control gender-filter" onchange="this.form.submit()">
                                <option value=""><?php echo e(__('All')); ?></option>
                                <option value="1" <?php echo e(request()->get('priority') === '1' ? 'selected' : ''); ?>><?php echo e(__('Enable')); ?></option>
                            </select>
                        </div>
                    ...
                    <table class="table">
                        <thead>
                            ...
                            <th><?php echo e(__('Actions')); ?></th>
                                ...
                                <th><?php echo e(__('Total Referrals')); ?></th>
                                 <th><?php echo e(__('Pancard Name')); ?></th>
                                 <th><?php echo e(__('Pancard Number')); ?></th>
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="action-btn bg-info ms-2">
                                    ...
                                    <td><?php echo e($user->total_coins); ?></td>
                                      <td><?php echo e(optional($user)->refer_code ?: ''); ?></td>
                                    <td><?php echo e(optional($user)->referred_by ?: ''); ?></td>
                                    <td><?php echo e(optional($user)->total_referrals); ?></td>
                                      <td><?php echo e(optional($user)->pancard_name ?: ''); ?></td>
                                    <td><?php echo e(optional($user)->pancard_number ?: ''); ?></td>
                                    ...
                                    <!-- Avatar Image -->
                                     <td><?php echo e($user->last_seen); ?></td>
                                       <td>
                                        <?php if($user->priority == 1): ?>
                                            <i class="fa fa-star text-warning"></i> 
                                            <span class="font-weight-bold text-warning"><?php echo e(__('Enabled')); ?></span>
                                        <?php else: ?>
                                            <i class="fa fa-star-o text-secondary"></i> 
                                            <span class="font-weight-bold text-muted"><?php echo e(__('Disabled')); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hima_admin_panel-3\resources\views/users/index.blade.php ENDPATH**/ ?>